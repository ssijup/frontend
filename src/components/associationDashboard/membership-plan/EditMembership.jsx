...
//     const handleShow= async ()=>{
//       await axiosInstance.get(`association/membership-plan/editform/${courtId}`).then((response)=>{
...
//     const handleClose = async (e) => {
//       e.preventDefault()
//       axiosInstance.patch(`/association/membership-plan/edit/${courtId}`,courtData).then((response)=>{
//         console.log( response.data);
//       })
//       setShow(false);
//     }
...
//         Court Name
//       </label>
//       <input value={courtData.name} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="court type" name='type' onChange={handleChange}/>
