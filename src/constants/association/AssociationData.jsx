export const Columns = [
      ...
      },
    {
      name: 'Edit',
      selector: (row) => (
        <button className="bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" onClick={handleEdit(id)}>
          Edit
        </button>
      ),
      sortable: false, 
